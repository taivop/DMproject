...
def originalToNumpyArray():
    import numpy as np
    # Load data starting from the 161430-th row
    # loaded 'diagnoses' and 'prescriptions' fields as Python string objects, not numpy string fields.
